# [Strangler Fig](StranglerFigApplication.html)
...
activities](/articles/patterns-legacy-displacement/) that we need for this kind of incremental approach.
...
This will involve identifying [seams](/bliki/LegacySeam.html)
...
When doing this, people often balk at the necessity of building [transitional architecture](/articles/patterns-legacy-displacement/transitional-architecture.html) to allow the new and legacy
...
the wider business in recognition of [Conways Law](/bliki/ConwaysLaw.html).
...
talk about how they [introduced seams](/articles/uncovering-mainframe-seams.html) into a mainframe system.
